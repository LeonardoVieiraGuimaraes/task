...
class TarefasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tarefa" do
    assert_difference("Tarefa.count") do
      post tarefas_url, params: { tarefa: { description: @tarefa.description, title: @tarefa.title, user_id: @tarefa.user_id } }
    end
  ...
  test "should update tarefa" do
    patch tarefa_url(@tarefa), params: { tarefa: { description: @tarefa.description, title: @tarefa.title, user_id: @tarefa.user_id } }
